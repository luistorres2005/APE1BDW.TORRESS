...
<head>
    ...
    <style>
        ...
        .card-contacto { background-color: #ffffff; border: none; border-radius: 0.5rem; }
        .text-negro { color: #000000; }
        
        /* Botón negro puro solicitado */
        .btn-black { background-color: #86d3cd; color: #ffffff; border: none; transition: background-color 0.2s ease; }
        .btn-black:hover { background-color: #9DBEBB; color: #ffffff; }
    </style>
</head>
            ...
            <div class="col-md-6">
                <div class="card card-contacto shadow-lg">
                    <div class="card-header border-bottom-0 pt-5 pb-0 text-center bg-transparent">
                        <h1 class="fw-bold h2 text-negro">Ponte en contacto</h1>
                        <p class="text-gris">Envíame un mensaje y te responderé lo antes posible.</p>
                    </div>
                    <div class="card-body px-5 pb-5 pt-4">
                        ...
                        <form method="POST" action="contacto.php">
                            <div class="mb-4">
                                <label for="nombre" class="form-label fw-bold text-negro">Nombre completo</label>
                                <input type="text" class="form-control" id="nombre" name="nombre" required placeholder="Ej: Juan Pérez">
                            </div>
                            <div class="mb-4">
                                <label for="correo" class="form-label fw-bold text-negro">Correo electrónico</label>
                                <input type="email" class="form-control" id="correo" name="correo" required placeholder="tu@correo.com">
                            </div>
                            <div class="mb-4">
                                <label for="mensaje" class="form-label fw-bold text-negro">Mensaje</label>
                                <textarea class="form-control" id="mensaje" name="mensaje" rows="5" required placeholder="Escribe tu mensaje aquí..."></textarea>
                            </div>
                            <button type="submit" class="btn btn-black w-100 fw-bold py-3 mt-2 rounded-2">Enviar Mensaje</button>
                        </form>
                    </div>
                </div>
            </div>
